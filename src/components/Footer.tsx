...
export function Footer() {
    return (
        <div className="relative z-20 w-full -mt-6" style={{ backgroundImage: `url(/public/images/grondvoorvoeter.png)` }}>
            <div className="w-full max-w-7xl mx-auto min-h-48 md:min-h-64 text-white pt-12 px-4 flex justify-between">
                <div className="">
                    <div className="h-20">
                        <img src="/public/images/LogoLetterworkWhite.svg" alt={companyName} title={companyName} className="h-20 object-contain " />
                    </div>
